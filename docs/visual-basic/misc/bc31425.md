...
---
# <a name="lttypenamegt-in-assembly-ltassemblynamegt-has-been-forwarded-to-itself-and-so-is-an-unsupported-type"></a>'&lt;typename&gt;'assembly' in에서&lt;assemblyname&gt;' 자체에 전달 되었습니다.는 지원 되지 않는 형식 이므로
