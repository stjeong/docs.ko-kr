...
---
# <a name="ltprocedurenamegt-method-for-event-lteventnamegt-cannot-be-marked-cls-compliant-because-its-containing-type-lttypenamegt-is-not-cls-compliant"></a>'&lt;procedurename&gt;'이벤트에 대 한 메서드'&lt;eventname&gt;'으로 표시할 수 없습니다 CLS 규격 포함 하는 형식'&lt;typename&gt;'이 CLS 규격이 아니므로
