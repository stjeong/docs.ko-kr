...
---
# <a name="cannot-inherit-interface-ltinterfacename1gt-because-the-interface-ltinterfacename2gt-from-which-it-inherits-could-be-identical-to-interface-ltinterfacename3gt-for-some-type-arguments"></a>인터페이스를 상속할 수 없습니다. '&lt;interfacename1&gt;' 때문에 인터페이스를 '&lt;interfacename2&gt;' 상속 된 없습니다 인터페이스와 동일할 수'&lt;interfacename3&gt;'에 대 한 일부 형식 인수
