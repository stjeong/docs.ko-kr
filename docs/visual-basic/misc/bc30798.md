...
---
# <a name="ltelementnamegt-for-the-imports-alias-to-ltqualifiedelementnamegt-does-not-refer-to-a-namespace-class-structure-interface-enum-or-module"></a>'&lt;elementname&gt;'에 대 한 Imports 별칭'에 대 한&lt;qualifiedelementname&gt;' Namespace, 클래스, 구조체, 인터페이스, 열거형 또는 모듈을 나타내지 않습니다
