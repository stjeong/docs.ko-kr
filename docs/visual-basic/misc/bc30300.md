...
---
# <a name="ltmethod1gt-and-ltmethod2gt-cannot-overload-each-other-because-they-differ-only-by-optional-parameters"></a>'&lt;method1&gt;'및'&lt;method2&gt;' 선택적 매개 변수 다르므로 서로 오버 로드할 수 없습니다.
