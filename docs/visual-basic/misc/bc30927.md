...
---
# <a name="mustoverride-cannot-be-specified-on-ltprocedurenamegt-because-it-is-in-a-partial-type-that-is-declared-notinheritable-in-another-partial-definition"></a>'MustOverride'에 지정할 수 없습니다 '&lt;procedurename&gt;' 'NotInheritable' 다른 부분 정의에서 선언 된 부분 형식에 있기 때문에
