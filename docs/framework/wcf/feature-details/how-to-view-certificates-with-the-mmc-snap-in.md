...
7.  에 **인증서 스냅인** 대화 상자에서 **컴퓨터 계정** 클릭 **다음**합니다. 필요에 따라 선택할 수 있습니다 **내 사용자 계정** 하거나 **서비스 계정**합니다. 컴퓨터의 관리자가 아닐 경우에는 본인의 사용자 계정에 대해서만 인증서를 관리할 수 있습니다.  
  
8.  에 **컴퓨터 선택** 대화 상자, 클릭 **마침**합니다.  
  
9. 에 **독립 실행형 스냅인 추가** 대화 상자, 클릭 **닫기**합니다.  
  
10. 에 **스냅인 추가/제거** 대화 상자, 클릭 **확인**합니다.  
  
11. 에 **콘솔 루트** 창에서 클릭 **인증서 (로컬 컴퓨터)** 인증서를 보려면 컴퓨터에 저장 합니다.  
  
12. 선택 사항입니다. 사용자 계정에 대한 인증서를 보려면 3 ~ 6단계를 반복하십시오. 선택 하는 대신 7 단계에서 **컴퓨터 계정**, 클릭 **내 사용자 계정** 8 ~ 10 단계를 반복 합니다.  
  
13. 선택 사항입니다. 에 **파일** 메뉴에서 클릭 **저장** 또는 **이름으로 저장**합니다. 나중에 다시 사용하기 위해 콘솔 파일을 저장합니다.  
...
4.  모든 인증서의 세부 정보를 보려면, 인증서를 선택 및 클릭 **보기**합니다.  
