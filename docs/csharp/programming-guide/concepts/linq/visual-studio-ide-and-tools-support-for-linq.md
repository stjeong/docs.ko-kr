...
## <a name="sqlmetal-command-line-tool"></a>SQLMetal 명령줄 도구  
 SQLMetal은 LINQ to SQL 응용 프로그램에서 사용할 기존 데이터베이스로부터 클래스를 생성하기 위해 빌드 프로세스에서 사용할 수 있는 명령줄 도구입니다. 자세한 내용은 [SqlMetal.exe(코드 생성 도구)](https://msdn.microsoft.com/library/819e5a96-7646-4fdb-b14b-fe31221b0614)를 참조하세요.  
