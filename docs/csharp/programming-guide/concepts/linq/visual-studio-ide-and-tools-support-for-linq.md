...
## <a name="object-relational-designer"></a>Object Relational Designer  
 개체 관계형 디자이너는 기본 데이터베이스의 관계형 데이터를 나타내는 C#의 클래스를 생성하기 위해 [LINQ to SQL](../../../../../docs/framework/data/adonet/sql/linq/index.md) 애플리케이션에서 사용할 수 있는 시각적 디자인 도구입니다. 자세한 내용은 [Visual Studio의 LINQ to SQL 도구](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)를 참조하세요.  
