...
---
# <a name="type-lttypenamegt-and-partial-type-lttypenamegt-conflict-in-container-ltcontainernamegt-but-are-being-merged-because-one-of-them-is-declared-partial"></a>형식 '&lt;typename&gt;'및 부분 형식'&lt;typename&gt;'컨테이너에서 충돌'&lt;containername&gt;', 그 중 하나가 부분으로 선언 되었으므로 병합 됩니다. 하지만
