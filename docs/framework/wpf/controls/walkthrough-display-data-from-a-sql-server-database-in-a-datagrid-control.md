...
5.  Model 콘텐츠 선택 화면에서 선택 **데이터베이스에서 생성** 을 클릭 한 다음 **다음**합니다.  
...
7.  이름 인지 확인 `AdventureWorksLT2008Entities` 하 고는 **으로 App.Config의 entity 연결 설정 저장** 확인란을 선택한 다음 클릭 **다음**합니다.  
  
8.  데이터베이스 개체 선택 화면에서 테이블 노드를 확장 하 고 선택 합니다 **제품** 하 고 **ProductCategory** 테이블입니다.  
...
### <a name="to-retrieve-and-present-the-data"></a>검색 하 여 데이터를 제공 합니다.  
