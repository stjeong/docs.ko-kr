...
---
# <a name="implementing-class-ltunderlyingclassnamegt-for-interface-ltinterfacenamegt-is-not-accessible-in-this-context-because-it-is-ltaccesslevelgt"></a>클래스의 구현&lt;underlyingclassname&gt;'interface'에 대 한&lt;interfacename&gt;'is not이 컨텍스트에서 액세스할 수 있기 때문 에'&lt;accesslevel&gt;'
