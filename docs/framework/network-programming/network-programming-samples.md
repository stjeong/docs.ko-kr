...
## <a name="in-this-section"></a>섹션 내용  
 [진행률 표시기 기술 샘플 다운로드](https://msdn.microsoft.com/library/t8w6294a(v=vs.85).aspx)  
 파일 다운로드의 진행률을 표시하는 방법을 보여 줍니다.  
  
 [FTP 클라이언트 기술 샘플](https://msdn.microsoft.com/library/b7810t5c(v=vs.85).aspx)  
 FTP 서버에 파일을 업로드하고 다운로드하는 방법을 보여 줍니다.  
  
 [HttpListener 기술 샘플](https://msdn.microsoft.com/library/y7cbb2y2(v=vs.85).aspx)  
 ...
 [Mailer 기술 샘플](https://msdn.microsoft.com/library/whw7xbk2(v=vs.85).aspx)  
 클라이언트 애플리케이션에서 전자 메일 메시지를 보내는 방법을 보여 줍니다.  
  
 [NetStat 도구 기술 샘플](https://msdn.microsoft.com/library/ks32hs88(v=vs.85).aspx)  
 NCLNetStat 네트워크 정보 도구를 보여 줍니다.  
  
 [네트워크 정보 기술 샘플](https://msdn.microsoft.com/library/2xatedhd(v=vs.85).aspx)  
 네트워크 정보를 표시하고 모니터링하는 방법을 보여 줍니다.  
  
 [Ping 클라이언트 기술 샘플](https://msdn.microsoft.com/library/5253acs7(v=vs.85).aspx)  
 원격 호스트를 ping할 수 있는 클라이언트 애플리케이션을 보여 줍니다.  
  
 [WebClient 기술 샘플](https://msdn.microsoft.com/library/fxk992zc(v=vs.85).aspx)  
 파일이나 데이터 업로드 또는 다운로드 등의 일반적인 작업을 수행하는 방법을 보여 줍니다.  
  
 [보안 스트림 샘플](https://msdn.microsoft.com/library/ms180980(v=vs.85).aspx)  
 ...
 [FTP 탐색기 기술 샘플](https://msdn.microsoft.com/library/ms233623(v=vs.85).aspx)  
