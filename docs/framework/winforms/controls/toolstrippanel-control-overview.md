...
|<xref:System.Windows.Forms.ToolStripPanel.Renderer%2A>|<xref:System.Windows.Forms.ToolStripRenderer>의 모양을 사용자 지정하는 데 사용되는 <xref:System.Windows.Forms.ToolStripPanel>를 가져오거나 설정합니다.|  
