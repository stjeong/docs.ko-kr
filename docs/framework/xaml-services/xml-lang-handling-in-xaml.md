...
|||  
|-|-|  
|*rfc3066lang*|파생 되는 문자열을 [RFC 3066](https://go.microsoft.com/fwlink/?LinkId=132454) 표준 언어 또는 언어 영역을 식별 합니다. 후자의 경우, 언어 및 지역이 단일 하이픈으로 구분됩니다. 값 및 형식에 대한 자세한 내용은 <xref:System.Windows.Markup.XmlLanguage> 를 참조하세요.|  
