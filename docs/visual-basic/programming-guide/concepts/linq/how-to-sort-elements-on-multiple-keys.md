...
## <a name="example"></a>예제  
 ...
 이 예제에서는 XML 문서로 을 사용합니다. [샘플 XML 파일: Namespace의 customers 및 Orders](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-file-customers-and-orders-in-a-namespace.md)합니다.  
