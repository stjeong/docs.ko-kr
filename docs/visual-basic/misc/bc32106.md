...
---
# <a name="type-argument-lttypeargumentnamegt-does-not-satisfy-the-class-constraint-for-type-parameter-lttypeparameternamegt"></a>형식 인수 '&lt;되었으며&gt;'형식 매개 변수에 대해 'Class' 제약 조건을 충족 하지 않는'&lt;typeparametername&gt;'
