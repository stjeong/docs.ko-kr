...
- [방법: 특정 패턴을 사용 하 여 파일을 디렉터리에 복사](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-copy-files-with-a-specific-pattern-to-a-directory.md)
