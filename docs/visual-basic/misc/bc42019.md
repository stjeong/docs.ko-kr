...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-runtime-errors-could-occur"></a>개체 연산자에 대해 사용 되는 형식의 피연산자가 '&lt;operatorsymbol&gt;' 않으면 런타임 오류가 발생할 수 있습니다
