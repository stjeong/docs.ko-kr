...
3.  `GetStudentGrades` 저장 프로시저를 가져오고 `CourseGrade` 엔터티를 반환 형식으로 지정합니다. 저장된 프로시저를 가져오는 방법에 대 한 자세한 내용은 [방법: 저장된 프로시저 가져오기](https://msdn.microsoft.com/library/24e68bf4-bd6d-428d-bc35-92d7b8e3736d)합니다.  
