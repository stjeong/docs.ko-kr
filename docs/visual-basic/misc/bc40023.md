...
ms.locfileid: "54642511"
---
# <a name="member-ltmembername1gt-conflicts-with-a-member-implicitly-declared-for-member-ltmembername2gt-in-the-base-type-ltbasetypenamegt-and-so-should-not-be-declared-overloads"></a>멤버 '&lt;membername1&gt;' 멤버와 충돌 암시적으로 선언 된 멤버에 대 한'&lt;membername2&gt;'의 기본 형식'&lt;basetypename&gt;'이므로 선언할 수 없습니다' 오버 로드 '
