...
## <a name="improved-quality-and-performance-of-text"></a>텍스트의 향상된 품질 및 성능  
 ...
 ![ClearType y 사용 하 여 텍스트&#45;방향&#45;별칭](../../../../docs/framework/wpf/advanced/media/typographyinwpf02.gif "TypographyInWPF02")  
...
스트로크와 강조 표시에 적용된 이미지 브러시의 예  
 ...
 에 대 한 자세한 합니다 <xref:System.Windows.Media.FormattedText> 개체를 참조 하십시오 [서식 있는 텍스트 그리기](../../../../docs/framework/wpf/advanced/drawing-formatted-text.md)합니다.  
