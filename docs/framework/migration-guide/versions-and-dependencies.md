...
|----------------------------|-----------------|--------------|---------------------------------------|----------------------------------------------------|-----------------------------------------------------------|-----------------------------------------| 
|4.7.2<br/><br/>[새로운 기능](../whats-new/index.md#whats-new-in-the-net-framework-472)<br/><br/>[내게 필요한 옵션의 새로운 기능](../whats-new/whats-new-in-accessibility.md#whats-new-in-accessibility-in-the-net-framework-472)|4| |✓ 2018년 4월 10일 업데이트(버전 1803) <br/><br/> + 10 Fall Creators Update(버전 1709) <br/> <br/> + 10 Creators Update(버전 1703) <br/> + 10 1주년 업데이트(버전 1607) <br/> + 8.1 <br/> +7 | ✓ Windows Server, 버전 1803 <br/> + Windows Server, 버전 1709 <br/> + 2016 <br/> + 2012 R2 <br/> + 2012 <br/> + 2008 R2 SP1 |`Release` DWORD 사용:<br/><br/> - 461808(Windows 10 2018년 4월 업데이트 및 Windows Server, 버전 1803) <br/> - 461814(다른 모든 OS 버전) <br/><br/> ([지침](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md) 참조)|
