...
베타 2 이후의 마이그레이션 문제는 [.NET Framework 4 응용 프로그램의 마이그레이션 문제: 베타 2에서 RTM](https://go.microsoft.com/fwlink/?LinkId=191505)을 참조하세요.
...
[.NET Framework 4 응용 프로그램의 마이그레이션 문제: 베타 2에서 RTM](https://go.microsoft.com/fwlink/?LinkId=191505)
