...
|[LINQ to XML과 기타 XML 기술 비교](../../../../visual-basic/programming-guide/concepts/linq/linq-to-xml-vs-other-xml-technologies.md)|LINQ를 to XML 다른 XML 구문 분석 및 조작 기술과 비교 합니다. XmlReader, XSLT, MSXML 및 XmlLite 합니다.|  
