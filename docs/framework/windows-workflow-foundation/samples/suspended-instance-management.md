...
2.  SQL Server 데이터베이스를 설정합니다.  
    ...
    1.  [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)] 명령 프롬프트에서 다음을 수행 하는 SuspendedInstanceManagement 샘플 디렉터리에서 "setup.cmd"를 실행 합니다.  
...
3.  서비스 큐를 설정합니다.  
    ...
    1.  [!INCLUDE[vs2010](../../../../includes/vs2010-md.md)]를 마우스 오른쪽 단추로 클릭 합니다 **SampleWorkflowApp** 프로젝트 및 클릭 **시작 프로젝트로 설정**합니다.  
