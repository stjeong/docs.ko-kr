...
7.  옆 줄임표 단추를 눌러 합니다 **실행** XAML 파일에 정의 된 워크플로에 대 한 찾아보기 단추  
  
     SampleWorkflows 폴더에 두 개의 샘플이 있습니다. parallel1.xaml 예제는 유휴 상태가 됩니다.  
  
8.  예를 선택 하면 키를 눌러 합니다 **실행** 단추입니다.  
  
9. 워크플로가 유휴 상태가 되 면 또는 경우는 **책갈피** 콤보 상자는 사용 가능한 책갈피로 채워집니다.  
