...
## <a name="sample-details"></a>샘플 세부 정보  
 ...
 Program.cs 응답 서비스 및 프로세스를 호출 하는 WCF 채널 팩터리를 사용할 수 있는 방법을 보여 줍니다. 이 방법은 WCF 서비스에 액세스하는 여러 방법 중 하나일 뿐입니다. <xref:System.Net.HttpWebRequest> 및 <xref:System.Net.WebClient> 같은 다른 .NET Framework 클래스를 사용하여 서비스에 액세스할 수도 있습니다. SDK의 다른 샘플 (같은 합니다 [선택 영역 자동 서식 지정](../../../../docs/framework/wcf/samples/automatic-format-selection.md) 샘플 및 [Basic Resource Service](../../../../docs/framework/wcf/samples/basic-resource-service.md) 샘플) 이러한 클래스를 사용 하 여 WCF 서비스와 통신 하는 방법을 보여 줍니다.  
