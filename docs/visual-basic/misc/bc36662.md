...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-the-lambda-expression-and-delegate-ltdelegatenamegt"></a>Option Strict On에서는 없도록 람다 식과 대리자 사이의 암시적 형식 변환에 축소 변환을 사용할 '&lt;delegatename&gt;'
