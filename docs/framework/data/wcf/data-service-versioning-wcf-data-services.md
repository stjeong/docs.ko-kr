...
## <a name="odata-protocol-versions"></a>OData 프로토콜 버전
 ...
 WCF Data Services는 이러한 버전 관리 시나리오를 처리 하는 OData에서 제공 하는 지원을 활용 합니다. 지원도 생성 하 고 데이터 모델 메타 데이터를 사용 하 여 클라이언트를 다른 버전의 OData 데이터를 사용 하는 경우 클라이언트 데이터 서비스 클래스를 만드는 데 사용 하 여 서비스입니다. 자세한 내용은 [OData: 프로토콜 버전 관리](http://go.microsoft.com/fwlink/?LinkId=186071)합니다.
