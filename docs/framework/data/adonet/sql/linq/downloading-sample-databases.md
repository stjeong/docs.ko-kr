...
2.  로 이동 합니다 [Northwind 및 Pubs 샘플 데이터베이스](https://go.microsoft.com/fwlink?linkid=64296) 웹 사이트입니다.  
  
3.  **다운로드**를 클릭합니다.  
  
4.  에 **파일 다운로드** 대화 상자에서 **저장**합니다.  
  
5.  파일을 다운로드 한 후 두 번 클릭 합니다 **Nwind.exe** 데이터베이스를 설치 하는 파일입니다.  
  
     기본적으로 데이터베이스에 설치 됩니다 *드라이브*: \SQL Server 2000 예제 데이터베이스.  
...
2.  로 이동 합니다 [Microsoft 다운로드 센터](https://go.microsoft.com/fwlink?linkid=74602) 웹 사이트입니다.  
  
3.  키워드 상자에 입력 **SQL Server Express**합니다.  
  
4.  **찾기**를 클릭합니다.  
  
5.  결과 페이지의 링크를 클릭 합니다 **Microsoft SQL Server 2005 Express Edition** 페이지를 다운로드 합니다.  
  
6.  웹 사이트의 설치 지침을 따릅니다.  
  
## <a name="downloading-management-studio-express"></a>Management Studio Express 다운로드  
 다운로드 한 데이터베이스를 수정 하려는 경우 데이터베이스를 액세스할 수 있습니다 **서버 탐색기** Visual studio에서 IDE (통합 개발 환경), 또는 Microsoft SQL Server Management Studio Express (SSMSE)를 사용 합니다. .  
  
#### <a name="to-download-management-studio-express"></a>Management Studio Express 다운로드하려면  
  
-   지침에 따라 합니다 [SSMSE 사이트](https://go.microsoft.com/fwlink/?LinkId=95933)합니다.  
