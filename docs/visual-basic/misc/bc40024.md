---
title: 속성 '&lt;propertyname&gt;'을 암시적으로 선언'&lt;implicitmembername&gt;', 멤버에 대 한 암시적으로 선언 된 멤버와 충돌 하 는'&lt;membername&gt;' 자료에서 클래스&lt;baseclassname&gt;'
ms.date: 07/20/2015
f1_keywords:
- vbc40024
- bc40024
...
ms.locfileid: "53767753"
---
# <a name="property-ltpropertynamegt-implicitly-declares-ltimplicitmembernamegt-which-conflicts-with-a-member-implicitly-declared-for-member-ltmembernamegt-in-the-base-class-ltbaseclassnamegt"></a>속성 '&lt;propertyname&gt;'을 암시적으로 선언'&lt;implicitmembername&gt;', 멤버에 대 한 암시적으로 선언 된 멤버와 충돌 하 는'&lt;membername&gt;' 자료에서 클래스&lt;baseclassname&gt;'
