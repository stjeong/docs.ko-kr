...
3.  ActiveX 컨트롤을 사용 하 고 클릭 하려는 옆의 확인란을 선택 **확인**합니다.  
    ...
    > [!NOTE]
    >  ActiveX 컨트롤에 대 한 interop 어셈블리를 수동으로 만들려면 Aximp 유틸리티를 사용할 수 있습니다. 자세한 내용은 [Aximp.exe (Windows Forms ActiveX 컨트롤 가져오기)](https://msdn.microsoft.com/library/482c0d83-7144-4497-b626-87d2351b78d0)합니다.  
...
## <a name="see-also"></a>참고 항목  
 ...
 [Aximp.exe(Windows Forms ActiveX 컨트롤 가져오기)](https://msdn.microsoft.com/library/482c0d83-7144-4497-b626-87d2351b78d0)  
