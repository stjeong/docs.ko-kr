...
-   대 한 추가 참조 자료에 대 한 합니다 [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] 인쇄 경로 및 다양 한 [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] 변환 옵션을 참조 하십시오 [Microsoft XPS 문서 변환기 (MXDC)](https://msdn.microsoft.com/library/windows/desktop/ff686803.aspx) 및의 "XPSDrv"를 [Windows 드라이버 키트](https://msdn.microsoft.com/library/windows/hardware/ff557573.aspx).  
