...
-   <xref:System.Windows.Forms.DataGridViewCellStyle>의 <xref:System.Windows.Forms.DataGridViewCellStyle.Format%2A> 속성을 설정합니다. 다음 코드 예제를 사용 하 여 특정 열에 대 한 형식을 설정 합니다 <xref:System.Windows.Forms.DataGridViewColumn.DefaultCellStyle%2A> 열 속성입니다. 값은 `UnitPrice` 열 괄호로 묶어 음수 값을 사용 하 여 현재 culture 별 통화 형식으로 표시 합니다. 값은 `ShipDate` 열 현재 culture 별 간단한 날짜 형식으로 표시 합니다. 에 대 한 자세한 내용은 <xref:System.Windows.Forms.DataGridViewCellStyle.Format%2A> 값을 참조 하세요 [형식](../../../../docs/standard/base-types/formatting-types.md)합니다.  
...
## <a name="robust-programming"></a>강력한 프로그래밍  
 최대 확장성을 공유 해야 <xref:System.Windows.Forms.DataGridViewCellStyle> 여러 행, 열 또는 셀 개별적으로 각 요소에 대 한 스타일 속성을 설정 하는 대신 동일한 스타일을 사용 하는 개체입니다. 자세한 내용은 [Windows Forms DataGridView 컨트롤의 크기 조정에 대 한 모범 사례](../../../../docs/framework/winforms/controls/best-practices-for-scaling-the-windows-forms-datagridview-control.md)합니다.  
