...
---
# <a name="extension-method-ltmethodnamegt-defined-in-ltmodulenamegt-is-not-generic-or-has-no-free-type-parameters-and-so-cannot-have-type-arguments"></a>확장 메서드 '&lt;methodname&gt;'에 정의 된'&lt;modulename&gt;' 제네릭이 아닌 (또는 사용 가능한 형식 매개 변수가 없는) 이므로 형식 인수를 사용할 수 없습니다.
