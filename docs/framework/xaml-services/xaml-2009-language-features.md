...
XAML 2009는 기존 XAML 언어 사양을 확장하는 새 XAML 언어 기능의 약식 용어입니다. XAML 2009에서는 여러 가지 새로운 지시문과 구문이 도입되었습니다. 여기에 포함 됩니다는 [X:arguments 지시문](../../../docs/framework/xaml-services/x-arguments-directive.md); [X:factorymethod 지시문](../../../docs/framework/xaml-services/x-factorymethod-directive.md); [X:reference 태그 확장명](../../../docs/framework/xaml-services/x-reference-markup-extension.md), [X:typearguments 지시문 ](../../../docs/framework/xaml-services/x-typearguments-directive.md); 공용 언어 기본 형식에 대 한 기본 제공 형식 (예를 들어 `x:Char`).  
