...
|`and`|[`let` 바인딩](functions/let-bindings.md)<br /><br />[멤버](members/index.md)<br /><br />[제약 조건](generics/constraints.md)|상호 재귀 바인딩 또는 속성 선언 및 여러 제약 조건을 제네릭 매개 변수를 사용 하 여에 사용 합니다.|
...
|`do`|[do 바인딩](functions/do-bindings.md)<br /><br />[루프: `for...to` 식](loops-for-to-expression.md)<br /><br />[루프: `for...in` 식](loops-for-in-expression.md)<br /><br />[루프: `while...do` 식](loops-while-do-expression.md)|루프 구문 또는 명령적 코드를 실행 하는 데 사용 합니다.|
...
|`exception`|[Visual C++에서 예외 처리](exception-handling/index.md)<br /><br />[예외 형식](exception-handling/exception-types.md)|예외 형식을 선언 하는 데 사용 합니다.|
...
|`let`|[`let` 바인딩](functions/let-bindings.md)|연결 하거나 값 또는 함수에 이름을 바인딩할 하는 데 사용 합니다.|
...
|`new`|[생성자(C++)](members/constructors.md)<br /><br />[제약 조건](generics/constraints.md)|선언, 정의 또는 생성 하거나 개체를 만들 수 있는 생성자를 호출 하는 데 사용 합니다.<br /><br />또한 제네릭 매개 변수 제약 조건에 나타내는 데 형식 특정 생성자를 있어야 합니다.|
...
|`then`|[조건식: `if...then...else`](conditional-expressions-if-then-else.md)<br /><br />[생성자(C++)](members/constructors.md)|조건부 식에 사용 합니다.<br /><br />또한 개체 생성 후 파생 작업을 수행 하는 데 사용 합니다.|
|`to`|[루프: `for...to` 식](loops-for-to-expression.md)|에 사용 되는 `for` 루프 범위를 나타냅니다.|
...
|`val`|[명시적 필드: `val` 키워드](members/explicit-fields-the-val-keyword.md)<br /><br />[시그니처](signatures.md)<br /><br />[멤버](members/index.md)|나타내는 값을 서명에서 또는 제한 된 상황에서 멤버를 선언 하는 형식을 사용 합니다.|
