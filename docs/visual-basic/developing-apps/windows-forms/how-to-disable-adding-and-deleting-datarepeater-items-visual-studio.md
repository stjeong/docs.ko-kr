...
---
# <a name="how-to-disable-adding-and-deleting-datarepeater-items-visual-studio"></a>방법: (Visual Studio) DataRepeater 항목 추가 및 삭제를 사용 하지 않도록 설정
기본적으로 사용자 추가 하거나 삭제할 수 있는 항목을 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> 제어 합니다. CTRL + N을 눌러 사용자가 새 항목을 추가할 수 있습니다 때를 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeaterItemEventArgs.DataRepeaterItem%2A> 포커스가 또는 클릭 하 여는 **AddNewItem** 단추를 <xref:System.Windows.Forms.BindingNavigator> 제어 합니다. 사용자 키를 눌러 항목을 삭제할 수 있습니다 경우 삭제할는 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeaterItemEventArgs.DataRepeaterItem%2A> 포커스가 또는 클릭 하 여는 **DeleteItem** 단추를 <xref:System.Windows.Forms.BindingNavigator> 제어 합니다.  
  
 추가 및/또는 디자인 타임 또는 런타임에 삭제를 비활성화할 수 있습니다.  
  
### <a name="to-disable-adding-and-deleting-at-design-time"></a>디자인 타임에 추가 및 삭제를 사용 하지 않도록 설정  
  
1.  Windows Forms 디자이너에서 선택 된 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> 제어 합니다.  
  
    > [!NOTE]
    >  컨트롤의 아래쪽 섹션을 선택 해야 합니다. 항목 템플릿 섹션을 선택 하면 서로 다른 속성 집합이 표시 됩니다.  
  
2.  속성 창에서 설정 된 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.AllowUserToAddItems%2A> 속성을 **False**합니다.  
  
3.  설정 된 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater.AllowUserToDeleteItems%2A> 속성을 **False**합니다.  
  
4.  Windows Forms 디자이너에서 선택 합니다 <xref:System.Windows.Forms.BindingNavigator> 컨트롤을 클릭 합니다 **AddNewItem** 단추 (에서 더하기 기호를 사용 하 여 단추).  
  
5.  속성 창에서 설정 된 <xref:System.Windows.Forms.ToolBarButton.Enabled%2A> 속성을 **False**합니다.  
  
6.  Windows Forms 디자이너에서 선택 합니다 <xref:System.Windows.Forms.BindingNavigator> 컨트롤을 클릭 합니다 **DeleteItem** 단추 (단추에 빨간색 X가 있는).  
  
7.  속성 창에서 설정 된 <xref:System.Windows.Forms.ToolBarButton.Enabled%2A> 속성을 **False**합니다.  
  
8.  구성 요소 트레이에 선택는 <xref:System.Windows.Forms.BindingSource> 는 <xref:Microsoft.VisualBasic.PowerPacks.DataRepeater> 바인딩됩니다.  
  
9. 속성 창에서 설정 된 <xref:System.Windows.Forms.BindingSource.AllowNew%2A> 속성을 **False**합니다.  
  
10. Windows Forms 디자이너에서 두 번 클릭 합니다 **DeleteItem** 단추 코드 편집기를 엽니다.  
...
### <a name="to-disable-adding-and-deleting-at-run-time"></a>실행된 시간에 추가 및 삭제를 사용 하지 않도록 설정  
