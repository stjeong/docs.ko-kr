...
---
# <a name="method-ltmethodnamegt-has-a-link-demand-but-overrides-or-implements-the-following-methods-which-do-not-have-a-link-demand-a-security-hole-may-exist"></a>메서드 '&lt;methodname&gt;' 링크 요청을 재정의 하거나 링크 요청이 없는 다음 메서드를 구현 합니다. 보안 허점이 있을 수도 있습니다.
