...
-   단추에 대 한 액세스 키 (ALT + 밑줄이 그어진된 문자)를 누릅니다. 액세스 키에 대 한 자세한 내용은 참조 하세요. [방법: Windows Forms 컨트롤에 대 한 액세스 키를 만들](../../../../docs/framework/winforms/controls/how-to-create-access-keys-for-windows-forms-controls.md)합니다.  
