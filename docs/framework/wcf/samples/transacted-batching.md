...
## <a name="demonstrates"></a>세부 항목  
 ...
 이 샘플에서는 단일 트랜잭션을 사용하여 여러 서비스 작업을 실행합니다. 이 트랜잭션은 성능 최적화 기능으로만 사용되면 응용 프로그램의 의미 체계에 영향을 주지 않습니다. 샘플을 기반으로 [트랜잭션 된 MSMQ 바인딩](../../../../docs/framework/wcf/samples/transacted-msmq-binding.md)합니다.  
