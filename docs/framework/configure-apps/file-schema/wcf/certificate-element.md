...
|`storeName`|열려는 X.509 인증서 저장소의 이름을 지정합니다. 유효한 값은 다음과 같습니다.<br /><br /> -AddressBook: 다른 사용자에 대 한 인증서 저장소입니다.<br />-AuthRoot: 인증서 저장소에서 타사 인증 기관 (Ca)입니다.<br />-CertificateAuthority: 중개 Ca (인증 기관)에 대 한 인증서 저장소입니다.<br />-허용 되지 않음: 인증서 저장소 해지 된 인증서입니다.<br />-인증서 저장소 my: 개인 인증서입니다.<br />-Root: 신뢰할 수 있는 루트 인증 기관 (Ca) 용 인증서 저장소입니다.<br />-TrustedPeople: 직접 신뢰할 수 있는 사용자 및 리소스에 대 한 인증서 저장소입니다.<br />-TrustedPublisher: 직접 신뢰할 수 있는 게시자 인증서 저장소입니다.<br /><br /> 기본값은 My입니다.|  
