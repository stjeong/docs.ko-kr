...
Visual Studio 또는 .NET Framework SDK를 사용하면 서비스로 설치되는 응용 프로그램을 만들어 서비스를 쉽게 만들 수 있습니다. 이 유형의 응용 프로그램을 Windows 서비스라고 합니다. 프레임워크 기능을 사용하여 서비스를 만들고 설치하고 시작 및 중지할 수 있으며 서비스 동작을 제어할 수도 있습니다.
...
[템플릿에서 프로젝트 만들기](https://msdn.microsoft.com/library/7c36d86a-6b79-4480-8228-0f925f1204b2) - 이 챕터에서 사용되는 프로젝트 유형과 이들 유형 중에서 선택하는 방법을 설명합니다.
