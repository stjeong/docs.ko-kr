...
> [!NOTE]
>  [!INCLUDE[linq_adonet](~/includes/linq-adonet-md.md)] .NET Framework SDK의 ADO.NET 섹션에 있는 설명서: [LINQ 및 ADO.NET](../../../../framework/data/adonet/linq-and-ado-net.md)합니다.
