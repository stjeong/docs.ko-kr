...
인식할 수 없는 이스케이프 시퀀스입니다.  
 ...
 [string](../../../csharp/language-reference/keywords/string.md)의 백슬래시(\\) 뒤에 예기치 않은 문자가 있습니다. 올바른 이스케이프 문자 중 하나가 필요합니다. 자세한 내용은 [Character Escapes](../../../standard/base-types/character-escapes-in-regular-expressions.md)를 참조하세요.  
