...
1.  이전 솔루션을 엽니다 [방법: 활동 만들기](../../../docs/framework/windows-workflow-foundation/how-to-create-an-activity.md) 사용 하 여 항목 [!INCLUDE[vs_current_long](../../../includes/vs-current-long-md.md)]합니다.  
