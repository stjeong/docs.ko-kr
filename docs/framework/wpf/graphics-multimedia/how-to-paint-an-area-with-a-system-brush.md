...
## <a name="example"></a>예제  
 ...
 그라데이션에 시스템 색을 사용 하는 방법을 보여 주는 예제를 보려면 [그라데이션에 시스템 색 사용](../../../../docs/framework/wpf/graphics-multimedia/how-to-use-system-colors-in-a-gradient.md)합니다.  
