...
---
# <a name="data-types-of-the-type-parameters-in-method-ltmethodnamegt-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>메서드에 있는 형식 매개 변수의 데이터 형식을 '&lt;methodname&gt;' 같은 형식으로 변환 하지 않습니다이 인수에서 유추할 수 없습니다
