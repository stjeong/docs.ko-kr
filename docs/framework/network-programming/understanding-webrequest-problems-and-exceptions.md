...
|<xref:System.Net.WebExceptionStatus.ConnectionClosed>|응용 프로그램이 이미 닫힌 소켓에 쓰려고 했습니다.|클라이언트 또는 서버가 오버로드되었습니다. 부하를 줄입니다.<br /><br /> <xref:System.Net.ServicePointManager.DefaultConnectionLimit%2A> 설정을 늘립니다.<br /><br /> <https://support.microsoft.com/?id=821268>을 참조하여 웹 서비스 성능 설정을 수정합니다.|  
