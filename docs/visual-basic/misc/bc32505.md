...
---
# <a name="systemruntimeinteropservicesdispidattribute-value-cannot-be-applied-to-lttypenamegt-because-microsoftvisualbasiccomclassattribute-reserves-zero-for-the-default-property"></a>'하므로 System.Runtime.InteropServices.DispIdAttribute' 값에 적용할 수 없습니다. '&lt;typename&gt;' 'Microsoft.VisualBasic.ComClassAttribute'는 기본 속성으로 0을 예약 하기 때문에
