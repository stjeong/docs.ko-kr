...
---
# <a name="return-and-parameter-types-of-ltoperatorgt-must-be-lttypenamegt-to-be-used-in-a-for-statement"></a>반환 및 매개 변수 형식은 '&lt;연산자&gt;'이어야 합니다.'&lt;typename&gt;' 'For' 문에서 사용할
