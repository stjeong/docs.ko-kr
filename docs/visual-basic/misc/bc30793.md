...
---
# <a name="trycast-operands-must-be-class-constrained-type-parameters-but-lttypeparameternamegt-has-no-class-constraint"></a>'TryCast' 피연산자에 있는 클래스 형식 매개 변수 여야 합니다. 하지만 '&lt;typeparametername&gt;' 제약 조건이 없는 클래스
