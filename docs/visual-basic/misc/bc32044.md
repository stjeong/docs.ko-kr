...
---
# <a name="type-argument-lttypeargumentnamegt-does-not-inherit-from-or-implement-the-constraint-type-lttypeparameternamegt"></a>형식 인수 '&lt;되었으며&gt;' 않습니다에서 상속 되지 않거나 구현 제약 조건 형식'&lt;typeparametername&gt;'
