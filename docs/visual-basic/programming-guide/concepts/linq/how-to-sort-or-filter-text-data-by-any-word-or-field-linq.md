...
1.  항목에서 scores.csv 데이터를 복사 [방법: 콘텐츠에서 서로 다른 파일 (LINQ) (Visual Basic) 조인](../../../../visual-basic/programming-guide/concepts/linq/how-to-join-content-from-dissimilar-files-linq.md) 솔루션 폴더에 저장 합니다.  
