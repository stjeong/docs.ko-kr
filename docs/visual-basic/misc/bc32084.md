...
---
# <a name="type-parameter-lttypeparametername1gt-must-have-either-a-new-constraint-or-a-structure-constraint-to-satisfy-the-new-constraint-for-type-parameter-lttypeparametername2gt"></a>형식 매개 변수 '&lt;typeparametername1&gt;'에 'New' 제약 조건 또는 형식 매개 변수에 대 한 'New' 제약 조건을 만족 하려면 'Structure' 제약 조건이 있어야 합니다'&lt;typeparametername2&gt;'
