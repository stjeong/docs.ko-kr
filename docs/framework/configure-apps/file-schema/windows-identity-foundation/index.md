...
## <a name="related-sections"></a>관련 단원  
 [Configuration, Administration, And Management](https://msdn.microsoft.com/library/1e03c389-de2c-4096-aaff-86b087e1bea0)(구성 및 관리) WIF 응용 프로그램 및 서비스를 구성하고 관리하는 방법을 설명합니다.
