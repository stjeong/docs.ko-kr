...
---
# <a name="type-of-ltvariablenamegt-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>유형은 '&lt;variablename&gt;' 루프 범위와 단계 변수가 같은 형식으로 확대 되지 않으므로 모호
