...
## <a name="example"></a>예제  
 ...
 다음 단계를 구현 하는 것은 <xref:System.Windows.Input.ICommandSource> 멤버입니다.  이 예제에서는 속성으로 구현 됩니다 <xref:System.Windows.DependencyProperty> 개체입니다.  이렇게 하면 데이터 바인딩을 사용 하 여 속성을 수 있습니다.  에 대 한 자세한 내용은 합니다 <xref:System.Windows.DependencyProperty> 클래스를 참조 하십시오 합니다 [종속성 속성 개요](../../../../docs/framework/wpf/advanced/dependency-properties-overview.md)합니다.  데이터 바인딩에 대 한 자세한 내용은 참조는 [데이터 바인딩 개요](../../../../docs/framework/wpf/data/data-binding-overview.md)합니다.  
