...
---
# <a name="type-argument-lttypeargumentnamegt-does-not-satisfy-the-structure-constraint-for-type-parameter-lttypeparameternamegt"></a>형식 인수 '&lt;되었으며&gt;'형식 매개 변수에 대 한 'Structure' 제약 조건을 충족 하지 않습니다'&lt;typeparametername&gt;'
