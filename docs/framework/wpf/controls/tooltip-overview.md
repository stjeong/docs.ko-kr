...
## <a name="using-the-properties-of-the-tooltip-and-tooltipservice-classes"></a>ToolTip 및 ToolTipService 클래스의 속성 사용  
 ...
 사용 하 여 도구 설명 콘텐츠의 위치를 지정 하려면 속성을 설정 하는 방법의 예는 <xref:System.Windows.Controls.ToolTip> 하 고 <xref:System.Windows.Controls.ToolTipService> 속성을 참조 하세요 [도구 설명 배치](../../../../docs/framework/wpf/controls/how-to-position-a-tooltip.md)합니다.  
