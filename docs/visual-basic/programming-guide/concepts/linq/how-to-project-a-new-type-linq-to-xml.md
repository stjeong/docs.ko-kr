...
```  
 ...
 이 예제에서는 합니다 `M:System.Xml.Linq.XElement.Element` 메서드 항목에 도입 된 [방법: (LINQ to XML)는 단일 자식 요소 검색 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-retrieve-a-single-child-element-linq-to-xml.md)합니다. 또한, 캐스트를 사용하여 `M:System.Xml.Linq.XElement.Element` 메서드에서 반환하는 요소의 값을 검색합니다.  
