...
## <a name="discussion"></a>토론
 ...
 사용자 지정 XAML 작성기를 빌드하려면 <xref:System.Windows.Markup.XamlWriter>에서 상속되는 클래스를 만듭니다. XAML 작성기가 종종 중첩 되어 것을 "내부" XAML 작성기를 추적 하기 위해 일반적인 합니다. 이러한 "내부 ' 기록기에 작업을 다음 처리를 스택의 나머지 부분을 위임 하기 위해 여러 진입점이 있을 수 있습니다, XAML 작성기의 나머지 스택에 대 한 참조로 생각할 수 있습니다.
