...
---
# <a name="variable-ltvariablenamegt-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>변수 '&lt;variablename&gt;'에 값 (구조 변수)이 할당 되기 전에 참조로 전달
