...
## <a name="example"></a>예제  
 ...
 이 예제에서는 XSD 스키마 을 사용합니다. [샘플 XSD 파일: Customers 및 Orders](../../../../visual-basic/programming-guide/concepts/linq/sample-xsd-file-customers-and-orders.md)합니다.  
