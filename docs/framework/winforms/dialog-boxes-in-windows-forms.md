...
-   [방법: 선택적으로 여러 속성을 사용 하 여 대화 상자 정보 검색](https://msdn.microsoft.com/library/56taefba\(v=vs.110\))  
  
-   [방법: 대화 상자의 부모 폼에서 정보를 검색 합니다.](https://msdn.microsoft.com/library/k70t19bb\(v=vs.110\))  
  
-   [대화 상자에 사용자 입력](https://msdn.microsoft.com/library/1s9ws53w\(v=vs.110\))  
  
-   [방법: 대화 상자의 결과 검색](https://msdn.microsoft.com/library/40x40td1\(v=vs.110\))  
  
-   [연습: 대화 상자 정보를 집합적으로 개체를 사용 하 여 검색](https://msdn.microsoft.com/library/cakx2hdw\(v=vs.110\))  
  
-   [방법: 대화 상자 닫기 및 사용자 입력 유지](https://msdn.microsoft.com/library/65ad5907\(v=vs.110\))  
  
-   [방법: 디자인 타임에 대화 상자 만들기](https://msdn.microsoft.com/library/55cz5x2c\(v=vs.110\))  
  
-   [방법: 메시지 상자를 표시 합니다.](https://msdn.microsoft.com/library/3tt9e94f\(v=vs.110\))  
