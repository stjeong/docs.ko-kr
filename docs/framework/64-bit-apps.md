...
-   64비트 응용 프로그램을 만들기 위한 Visual Studio 지원에 대한 자세한 내용은 [Visual Studio 개발 환경 64비트 지원](https://msdn.microsoft.com/library/b08ff3ad-c6fd-468f-94d5-01a61aab6833)을 참조하세요.  
