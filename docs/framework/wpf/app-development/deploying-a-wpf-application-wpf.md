...
## <a name="installing-the-net-framework"></a>.NET Framework 설치  
 ...
 자세한 내용은 [.NET Framework 및 애플리케이션 배포](../../../../docs/framework/deployment/index.md)를 참조하세요.  
