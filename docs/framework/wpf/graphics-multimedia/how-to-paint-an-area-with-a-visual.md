...
## <a name="example"></a>예제  
 ...
 에 대 한 자세한 내용은 <xref:System.Windows.Media.VisualBrush> 및 추가 예제를 보려면 합니다 [이미지, 그림 및 시각적 표시로 그리기](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md) 개요.  
