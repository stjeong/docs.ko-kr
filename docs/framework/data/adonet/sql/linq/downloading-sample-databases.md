...
사용 하 여 SQL Server 인스턴스에서 데이터베이스를 다시 만들어야 Northwind 데이터베이스를 사용 하려면 먼저 [SQL Server Management Studio](#get_ssms) 또는 유사한 도구를 실행 하 여 `instnwnd.sql` 설치 폴더에서 스크립트 파일입니다.
...
사용 중인 경우 [Visual Studio](https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017), SQL Server Express LocalDB Professional 이상 버전 뿐만 아니라 무료 Community edition에 포함 됩니다.  
