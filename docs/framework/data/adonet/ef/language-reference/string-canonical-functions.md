...
|`Right(string, length)`|마지막 반환 `length` 에서 문자를 `string`입니다. `string` 길이가 `length`보다 작으면 전체 문자열이 반환됩니다.<br /><br /> **인수**<br /><br /> `string`: `String`입니다.<br /><br /> `length`: `Int16`, `Int32`, `Int64` 또는 `Byte`입니다. `length`는 0보다 작을 수 없습니다.<br /><br /> **반환 값**<br /><br /> `String`<br /><br /> **예제**<br /><br /> `-- The following example returns xyz.`<br /><br /> `Right('abcxyz', 3)`|  
