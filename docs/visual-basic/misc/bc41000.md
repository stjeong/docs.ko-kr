...
---
# <a name="attribute-ltattributenamegt-cannot-be-specified-more-than-once-in-this-project-even-with-identical-parameter-values"></a>특성 '&lt;attributename&gt;'도 동일한 매개 변수 값을 사용 하 여이 프로젝트에 두 번 이상 지정할 수 없습니다
