...
|<xref:System.Windows.Media.DrawingGroup.Transform%2A>|변환 된 <xref:System.Windows.Media.DrawingGroup> 내용입니다. 예는 [방법: 그리기에 변환 적용](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.5/ms742304(v=vs.90))합니다.|![회전된 DrawingGroup](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-rotate.png "graphicsmm_rotate")|  
