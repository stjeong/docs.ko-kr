...
|Verbose|"Positive" 이벤트: 성공적인 중요 시점을 표시 하는 이벤트입니다.|사용자 코드와 서비스에 대한 하위 수준 이벤트를 내보냅니다.|일반적으로 디버깅 또는 응용 프로그램 최적화에 이 수준을 사용할 수 있습니다.<br /><br /> -메시지 헤더를 확인 합니다.|관리자<br /><br /> 응용 프로그램 개발자<br /><br /> 제품 개발자|  
