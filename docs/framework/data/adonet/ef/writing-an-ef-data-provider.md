...
## <a name="sample"></a>샘플  
 참조를 [Entity Framework Sample Provider](https://go.microsoft.com/fwlink/?LinkId=180616) 의 예제는 [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] SQL Server 이외의 데이터 소스를 지 원하는 공급자입니다.  
