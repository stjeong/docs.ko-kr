...
-   컨트롤의 스마트 태그를 클릭 **추가 탭** 또는 **탭 제거**  
     ...
     에 **속성** 창에서 클릭 합니다 **줄임표** 단추 (![VisualStudioEllipsesButton 스크린 샷](../../../../docs/framework/winforms/media/vbellipsesbutton.png "vbEllipsesButton")) 옆에 <xref:System.Windows.Forms.TabControl.TabPages%2A> 열려면 속성을 **TabPage 컬렉션 편집기**합니다. 클릭 합니다 **추가** 하거나 **제거** 단추입니다.  
